# ⚡ Pembaca Pulsa Optik Meteran Listrik & Air ESP32
...
Penghitung pulsa LED optik meteran utilitas via fototransistor berkecepatan tinggi dengan interrupt ISR hardware dan akumulasi energi persistensi NVS.
...
1. Buka file **`esp32-smart-meter-optical-pulse.ino`** menggunakan **Arduino IDE 2.0+** atau PlatformIO.
